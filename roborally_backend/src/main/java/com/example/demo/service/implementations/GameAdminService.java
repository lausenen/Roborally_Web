...
public class GameAdminService implements IGameAdminService {
   ...
   /*List<Game> result = new ArrayList<>();
    ...
    @Override
    public Game joinAsUser(User user, int gameId) throws ServiceException, DaoException {
    ...
    @Override
    public Game leaveAsUser(User user, int gameId) throws ServiceException, DaoException {
        Game game = getGame(gameId);
